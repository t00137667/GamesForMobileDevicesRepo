    ...
    void Update()
    {
        if (Input.touchCount > 0)
        {
            ...
            if (Input.touchCount == 2)
            {
                ...
                if ( ((Input.touches[0].phase == TouchPhase.Stationary || (Input.touches[0].phase == TouchPhase.Moved && Input.touches[0].deltaPosition.magnitude < stationaryTolerance))  && 
                    Input.touches[1].phase == TouchPhase.Moved && Input.touches[1].deltaPosition.magnitude > movementTolerance/2) ||
                    ((Input.touches[1].phase == TouchPhase.Stationary || (Input.touches[1].phase == TouchPhase.Moved && Input.touches[1].deltaPosition.magnitude < stationaryTolerance)) && 
                    Input.touches[0].phase == TouchPhase.Moved && Input.touches[0].deltaPosition.magnitude > movementTolerance/2) )
                {
                    ...
                    if (Mathf.Abs(angle) > 15f && Mathf.Abs(scaleRatio) < 40.5f)
                    {
                ...
                if (Input.touches[0].phase == TouchPhase.Moved && Input.touches[0].deltaPosition.magnitude > movementTolerance ||
